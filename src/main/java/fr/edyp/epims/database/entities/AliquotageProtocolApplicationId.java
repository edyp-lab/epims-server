...
/**
 * AliquotageProtocolApplicationId generated by hbm2java
 */
@Embeddable
public class AliquotageProtocolApplicationId implements java.io.Serializable {
	...
	public AliquotageProtocolApplicationId() {
	}

	public AliquotageProtocolApplicationId(Integer id, String name, String date, String actor,
			String comment, Integer protocol, Integer result, Integer subSampleCount) {
		this.id = id;
		this.name = name;
		this.date = date;
		this.actor = actor;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AliquotageProtocolApplicationId))
			return false;
		AliquotageProtocolApplicationId castOther = (AliquotageProtocolApplicationId) other;
		...
		return ((this.getId() == castOther.getId())
				...
				&& ((this.getSubSampleCount() == castOther.getSubSampleCount())
						|| (this.getSubSampleCount() != null && castOther.getSubSampleCount() != null
								&& this.getSubSampleCount().equals(castOther.getSubSampleCount())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getSubSampleCount() == null ? 0 : this.getSubSampleCount().hashCode());
		return result;
	}
