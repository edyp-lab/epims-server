...
/**
 * SeparationProtocolApplicationId generated by hbm2java
 */
@Embeddable
public class SeparationProtocolApplicationId implements java.io.Serializable {
	...
	public SeparationProtocolApplicationId() {
	}

	public SeparationProtocolApplicationId(Integer id, String name, String date, String actor,
			String comment, Integer protocol, Integer result) {
		this.id = id;
		this.name = name;
		this.date = date;
		this.actor = actor;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SeparationProtocolApplicationId))
			return false;
		SeparationProtocolApplicationId castOther = (SeparationProtocolApplicationId) other;
