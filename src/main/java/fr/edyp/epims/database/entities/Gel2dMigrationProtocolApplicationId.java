...
/**
 * Gel2dMigrationProtocolApplicationId generated by hbm2java
 */
@Embeddable
public class Gel2dMigrationProtocolApplicationId implements java.io.Serializable {
	...
	public Gel2dMigrationProtocolApplicationId() {
	}

	public Gel2dMigrationProtocolApplicationId(Integer id, String name, String date, String actor,
											   String comment, Integer protocol, Integer result, String massStart, String massEnd,
											   String denaturingAgent, String piStart, String piEnd) {
		this.id = id;
		this.name = name;
		this.date = date;
		this.actor = actor;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Gel2dMigrationProtocolApplicationId))
			return false;
		Gel2dMigrationProtocolApplicationId castOther = (Gel2dMigrationProtocolApplicationId) other;
		...
		return ((this.getId() == castOther.getId())
				...
				&& ((this.getPiStart() == castOther.getPiStart()) || (this.getPiStart() != null
						&& castOther.getPiStart() != null && this.getPiStart().equals(castOther.getPiStart())))
				&& ((this.getPiEnd() == castOther.getPiEnd()) || (this.getPiEnd() != null
						&& castOther.getPiEnd() != null && this.getPiEnd().equals(castOther.getPiEnd())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getPiStart() == null ? 0 : this.getPiStart().hashCode());
		result = 37 * result + (getPiEnd() == null ? 0 : this.getPiEnd().hashCode());
		return result;
	}
