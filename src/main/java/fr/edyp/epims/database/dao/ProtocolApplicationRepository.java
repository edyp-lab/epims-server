...
import fr.edyp.epims.database.entities.ProtocolApplication;
...
public interface ProtocolApplicationRepository extends JpaRepository<ProtocolApplication, Integer> {
